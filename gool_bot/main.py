...
# The owner's PREMATCH delivery remains on GitHub Actions. This container runs
# the same scanner only for additional subscribers, avoiding duplicate owner alerts.
