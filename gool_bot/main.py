...
import telegram_subscribers,subscriber_persistence_patch,telegram_interactive_live_patch,owner_market_tape_patch,market_test_signal,market_spike_signal,market_recommendation_results,market_results_telegram_patch
...
async def market_test_loop():
 while True:
  try:
   ...
   spikes=await asyncio.to_thread(market_spike_signal.scan_once)
