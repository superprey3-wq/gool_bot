...
async def main():
 ...
 logger.info("GOOL LIVE | build=%s | live-only primary | remote_market_node=%s | BEST BET=on+results | owner total alerts=on",BUILD_ID,bool(market_node_bridge.URL));_mem("main_started")
 try:
  while True:
