...
def render_engine_card(match,engine,score=0,delta=None,odd=None,result=None):
 ...
 d.rounded_rectangle((55,955,1145,1158),22,fill=(9,18,31),outline=LINE,width=1);d.text((82,980),'ПОЧЕМУ GOOL ДАЛ СИГНАЛ',font=F(22,True),fill=accent);yy=1023
 for line in textwrap.wrap(_why(engine,score,delta,timing),width=88)[:4]:d.text((82,yy),line,font=F(18),fill=WHITE);yy+=29
